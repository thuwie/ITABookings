                    ...
                    <tr>
                        <td style="padding:30px;">
                            ...
                            <p style="line-height:1.6; font-size:16px;">
                                Sau quá trình xem xét và đánh giá, chúng tôi thấy bạn đủ tiêu chí để trở thành một tài xế của doanh nghiệp <?= htmlspecialchars($businessName) ?>  trên hệ thống ITABookings.
                            </p>
                            <p style="line-height:1.6; font-size:16px;">
